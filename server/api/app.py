...
def load_data():
    ...
    try:
        ...
        parquet_files = [
            DATA_DIR / 'specialists_final_with_npi.parquet',
            DATA_DIR / 'specialists_with_topics_final.parquet', 
            DATA_DIR / 'npi_enhanced_specialists.parquet',
            DATA_DIR / 'main_dataset.parquet'  # From your drive download folder
        ]
        ...
        topic_files = [
            DATA_DIR / 'topic_keywords.json',
            DATA_DIR / 'disease_tracking.json'  # Alternative location
        ]
